...
function agregar() {
  ...
  let fila =
    '<div class="transacion" id=' +
    id_row +
    '><div class="t-fecha-i" id="tfecha">' +
    fecha +
    '</div><div class="t-tiel-i" id="tcargo">' +
    cargo +
    '<div class="t-monto-i"><div class="bolivares"><div class="moneda">Bs.</div><div class="monto-b-i" id="tmonto">' +
    monto +
    '</div></div><div class="dolares"><div class="moneda">$</div><div class="monto-d-i">0</div></div></div></div><div class="tbtn"><div class="tbtn-editar"><a href="#" onclick="monto(' +
    cant +
    ')">Editar</a></div><div class="tbtn-eliminar"><a href="#" onclick="eliminar(' +
    cant +
